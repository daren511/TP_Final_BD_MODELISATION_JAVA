   ...
   private void initComponents() {
               ...
               .addGroup(layout.createSequentialGroup()
                  ...
                  .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                     .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(CB_Genres, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(BTN_Lister, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE))
                     .addComponent(DGV_Inventaire, javax.swing.GroupLayout.PREFERRED_SIZE, 526, javax.swing.GroupLayout.PREFERRED_SIZE)))
               .addGroup(layout.createSequentialGroup()
                  .addGap(217, 217, 217)
    ...
    private void BTN_ListerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_ListerActionPerformed
       ...
       // DGV_Inventaire.is
        try
        {
            ...
            CallableStatement stm2 = connBD.getConnection().prepareCall("{? =call GESTIONINVENTAIRE.LISTERGENRE(?)}");
    ...
    private void BTN_RechercheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_RechercheActionPerformed
        ...
        try
        {
            ...
            CallableStatement stm2 = connBD.getConnection().prepareCall("{? =call GESTIONINVENTAIRE.RECHERCHESANSGENRE(?)}");
            stm2.registerOutParameter(1,OracleTypes.CURSOR);
